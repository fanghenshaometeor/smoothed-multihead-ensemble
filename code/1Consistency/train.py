...
hyperparam='h-'+str(args.num_heads)+'-m-'+str(args.num_noise_vec)+'-lbdlast-'+str(args.lbdlast)+'-lbd-'+str(args.lbd)
...
def train_epoch(net, trainloader, optimizer, epoch):
    ...
    for batch_idx, batch in enumerate(trainloader):
        ...
        for b_data, b_label in mini_batches:
            ...
            loss_ce, all_losses, loss_con = ct_con_loss(all_logits_chunk, b_label, threshold, args.lbd)
            for idx in range(args.num_heads):
