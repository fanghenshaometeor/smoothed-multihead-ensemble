...
# ======== options ==============
parser = argparse.ArgumentParser(description='Training SPACTE with Consistency')
# -------- file param. --------------
...
def train_epoch(net, trainloader, optimizer, epoch):
    ...
    for batch_idx, batch in enumerate(trainloader):
        ...
        for b_data, b_label in mini_batches:
            ...
            # -------- compute the ce and consistency loss via self-paced circular-teaching
            ...
            # -------- SUM the losses
            total_loss = loss_ce + loss_ortho + loss_con
